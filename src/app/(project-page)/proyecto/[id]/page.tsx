    ...
    >
      ...
      >
        ...
        >
          ...
          <div className='grid lg:grid-cols-3 sm:grid-cols-1 lg:gap-10 gap-8 overflow-y-auto w-full'>
            {/* importancia */}
      ...
      <ProjectPageSection className='bg-bg-300' fullLgHeight={false}>
        <div id='actores' className='projectColumnSection text-primary-200'>
          ...
          <div className='grid lg:grid-cols-3 sm:grid-cols-1 lg:gap-10  gap-8 w-full lg:h-[50vh] h-fit pt-12'>
            {/* Actores */}

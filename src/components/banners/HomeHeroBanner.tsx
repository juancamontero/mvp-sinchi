...
export const HomeHeroBanner = ({title, subTitle}: Props) => {
  ...
  return (
    <div
      className={`xBannerPaddings sm:py-3 py-2 mx-auto w-full lg:py-4 bg-bg-300 my-1`}
    >
      {/* main content starts */}
      ...
      <div className='flex flex-col justify-center items-center'>
        ...
        <div className='max-w-xl'>
          <h2 className={`xBannerPaddings titleBanner text-center text-primary-200 leading-tight`}>
            {title}
          </h2>
